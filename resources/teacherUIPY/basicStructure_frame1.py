...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.listArea_frame = QtWidgets.QFrame(Frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listArea_frame.sizePolicy().hasHeightForWidth())
        self.listArea_frame.setSizePolicy(sizePolicy)
        self.listArea_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.listArea_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.listArea_frame.setObjectName("listArea_frame")
        self.verticalLayout.addWidget(self.listArea_frame)
